...
if CoreGui:FindFirstChild("HexScriptCore") then
    CoreGui.HexScriptCore:Destroy()
end
local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "HexScriptCore"
...
TextLabel.BackgroundTransparency = 1
TextLabel.Text = "HEXSCRIPT | discord.gg/sourceshubs"
TextLabel.TextColor3 = Color3.fromRGB(0, 0, 0)
...
for i, v in ipairs(t1) do
    ...
    Frame4.BackgroundColor3 = Color3.fromRGB(240, 240, 240)
    ...
    if v28.HasKey then
        ...
        UIStroke3.Color = Color3.fromRGB(200, 200, 200)
        TextLabel3.Text = "KEY"
    ...
    TextButton2.BackgroundColor3 = Color3.fromRGB(230, 230, 230)
    ...
    TextButton2.MouseButton1Click:Connect(function()
        ...
        TextButton2.TextColor3 = Color3.fromRGB(0, 0, 0)
        TextButton2.BackgroundColor3 = Color3.fromRGB(200, 255, 200)
        UIStroke4.Color = Color3.fromRGB(0, 100, 0)
...
local function v45(p5)
    ...
    if Head:FindFirstChild("HexScriptTag") then
        Head.HexScriptTag:Destroy()
    end

    local BillboardGui = Instance.new("BillboardGui")

    BillboardGui.Name = "HexScriptTag"
    ...
    TextLabel4.Text = "https://discord.gg/sourceshubs"
