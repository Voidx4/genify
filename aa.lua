...
UIGradient.Color = ColorSequence.new({
	...
	ColorSequenceKeypoint.new(0.5, Color3.fromRGB(55, 10, 10)),
...
TextLabel.BackgroundTransparency = 1
TextLabel.Text = "SOURCES HUB | discord.gg/sourceshubs"
TextLabel.TextColor3 = Color3.fromRGB(240, 40, 40)
...
for i, v in ipairs(t1) do
    ...
    if v28.HasKey then
        ...
        UIStroke3.Color = Color3.fromRGB(220, 180, 20)
        TextLabel3.Text = "KEY"
    ...
    TextButton2.BackgroundColor3 = Color3.fromRGB(28, 10, 10)
    TextButton2.Text = "EXECUTE"
    TextButton2.TextColor3 = Color3.fromRGB(255, 50, 50)
